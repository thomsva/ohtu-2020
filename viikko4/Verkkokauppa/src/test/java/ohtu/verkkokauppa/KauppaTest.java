...
public class KauppaTest {
    ...
    public void kahdenEriTuotteenOstossaMetodiaTilisiirtoKutsutaanOikeallaAsiakkaallaTilinumerollaJaSummalla() {
        Varasto varasto = mock(Varasto.class);
        // m‰‰ritell‰‰n ett‰ tuote numero 1 on maito jonka hinta on 5 ja saldo 10
        // m‰‰ritell‰‰n ett‰ tuote numero 2 on omena jonka hinta on 1 ja saldo 10
        when(varasto.saldo(1)).thenReturn(10);
    ...
    public void aloitaAsiointiNollaaEdellisetOstokset() {
        ...
        k.aloitaAsiointi();
        k.lisaaKoriin(1);     // ostetaan tuotetta numero 1 eli maitoa
        k.aloitaAsiointi();   // aloitetaan alusta
        k.lisaaKoriin(1);     // ostetaan tuotetta numero 1 eli maitoa
        k.tilimaksu("pekka", "12345");
    ...
    public void uusiViitePyydet‰‰n() {
        ...
        // sitten suoritetaan varmistus, ett‰ viitegeneraattoria on kutsuttu
