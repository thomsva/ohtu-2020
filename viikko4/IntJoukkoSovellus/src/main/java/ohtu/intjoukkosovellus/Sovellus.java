...
public class Sovellus {
    ...
    private static void lisaa() {
        ...
        joukko = mikaJoukko();
        System.out.println("");
        System.out.print("Mik√§ luku lis√§t√§√§n? ");
    ...
    private static void poista() {
        ...
        int lisLuku;
        Scanner lukija = new Scanner(System.in);
        System.out.print("Mist√§ joukosta? ");
        joukko = mikaJoukko();
        System.out.print("Mik√§ luku poistetaan? ");
        lisLuku = lukija.nextInt();
    ...
    public static void main(String[] args) {
        ...
        System.out.println("K√§yt√∂ss√§si ovat joukot A, B ja C.");
        System.out.println("Komennot ovat lis‰‰(li), poista(p), kuuluu(k), yhdiste(y), erotus(e), leikkaus(le) ja lopetus(quit)(q).");
        System.out.println("Joukon nimi komentona tarkoittaa pyyntˆ‰ tulostaa joukko.");

        Scanner lukija = new Scanner(System.in);
        while (true) {
            luettu = lukija.nextLine();
            if (luettu.equals("lis‰‰") || luettu.equals("li")) {
                lisaa();
                ...
                System.out.println("Komennot ovat lis‰‰(li), poista(p), kuuluu(k), yhdiste(y), erotus(e) ja leikkaus(le).");
            }
            System.out.println("Komennot ovat lis‰‰(li), poista(p), kuuluu(k), yhdiste(y), erotus(e) ja leikkaus(le).");
        }
    }
