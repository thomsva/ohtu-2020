...
public class Stepdefs {
    ...
    public void newUserTooShortUsernameAndPasswordAreGiven(String username, String password) {
        newUserWith(username, password, password);
    }   

    @When("a valid username {string} and too short password {string} and matching password confirmation are entered")
    public void newUserCorrectUsernameAndTooShortPasswordAreGiven(String username, String password) {
        newUserWith(username, password, password);
    } 

    @When("When  a valid username {string} and password {string} and a password confirmation {string} are entered")
